...
class AudioManager:
    ...
    def start_audio_stream(
        ...
        try:
            # Validate devices
            # print("[uSIP.AudioManager] Validating devices...")
            ...
            # Create RTP socket
            # print("[uSIP.AudioManager] Creating sockets...")
            ...
            # Open audio streams
            # print("[uSIP.AudioManager] Opening the streams...")
            ...
            # print("[uSIP.AudioManager] Starting audio thread...")
            self.audio_thread = threading.Thread(target=self._audio_loop, daemon=True)
            self.audio_thread.start()
            
            # print("[uSIP.AudioManager] Audio streaming started.")
